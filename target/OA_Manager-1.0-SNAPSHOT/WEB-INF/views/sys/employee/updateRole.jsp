...
<div class="layuimini-container layui-col-space30">
    <div class="layuimini-main">
        <form class="layui-form" lay-filter="updateRole">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label required">角色选择</label>
                <div class="layui-input-block">
                    <select name="roleId" lay-filter="roleId" id="roleId" lay-verify="required"></select>
                </div>
            </div>
            <div class="layui-form-item">
...
<script type="text/javascript">
    layui.use(['jquery', 'layer', 'form'], function () {
        ...
        form.on('submit(*)', function (data) {
            ...
            $.getJSON('${pageContext.request.contextPath}/employee/updateRole',{'employeeIdList':JSON.stringify(employeeIdList),'roleId':data.field.roleId},function (result) {
