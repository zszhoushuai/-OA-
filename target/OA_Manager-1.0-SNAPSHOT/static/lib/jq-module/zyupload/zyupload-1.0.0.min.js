        ...
        return this.each(function () {
            ...
            this.createHtml = function () {
                ...
                if (para.dragDrop) {
                    ...
                    html += '				<div id="status_info" class="info">选中0张文件，?0B?</div>';
                    html += '				<div class="btns">';
            ...
            this.funSetStatusInfo = function (files) {
                ...
                $("#status_info").html("选中" + num + "张文件，?" + size + "?")
            };
                    ...
                    if (newStr.split(".")[0] != null) {
                        ...
                        if (jQuery.inArray(type, para.fileType) > -1) {
                            if (file.size >= para.fileSize) {
                                alert('您这?"' + file.name + '"文件大小过大')
                            } else {
                                arrFiles.push(file)
                            }
                        } else {
                            alert('您这?"' + file.name + '"上传类型不符?')
                        }
                    } else {
                        alert('您这?"' + file.name + '"没有类型, 无法识别')
                    }
                }
                return arrFiles
            };
