 ...
 * @version springmvc-interceptor.xml.springmvc-interceptor.xml
 */
...
layui.define(['laypage', 'form'], function (exports) {
    ...
    var IconPicker = function () {
            this.v = 'springmvc-interceptor.xml.springmvc-interceptor.xml';
        }, _MOD = 'iconPickerFa',
        _this = this,
        $ = layui.jquery,
            ...
            createList: function (text) {
                ...
                if (page) {
                    ...
                    pageHtml = '<div class="layui-iconpicker-page" id="' + PAGE_ID + '">' +
                        ...
                        '<span id="' + PAGE_ID + '-current">springmvc-interceptor.xml</span>/' +
